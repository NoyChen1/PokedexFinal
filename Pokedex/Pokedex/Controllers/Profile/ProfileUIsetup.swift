...
extension ProfileViewController {
    ...
    func makeFavoritesButton() {
        favoritesButton = UIButton(frame: CGRect(x: view.frame.width*44/170, y: view.frame.height*83/100, width: view.frame.width*55/100, height: view.frame.height*5/100))
